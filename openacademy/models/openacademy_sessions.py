...
class Sessions(models.Model):
    ...
    can_edit_instructor = fields.Boolean(compute='_compute_can_edit_instructor')


    @api.depends('instructor_id')
    def _compute_can_edit_instructor(self):
        self.can_edit_instructor = self.env.user.has_group('openacademy.group_instructor')
    ...
    @api.multi
    def subscribe(self):
        self.attendee_ids |= self.env.user.partner_id
